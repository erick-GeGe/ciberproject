...
var isuer_final;
    ...
    const request = https.request(options, function(res) {
        ...
        if (res.socket.authorized == true) {
            console.log("entroa al certificado autprizado")
        ...
        do {
            ...
            console.log(cert.issuerCertificate['modulus'])
        ...
        //console.log(typeof(JSON.stringify(isuer_final['CN'])));
...
function comprobarCer(){
    console.log(Cont_nivelCh);
    console.log(Cont_nivelFx);
